...
function ReportProblem({ setReport, setClickMore }) {
  return (
    <>
      ...
      >
        <div className="scrollbar-hide min-h-[55vh]  my-auto bg-[#ffffff] dark:bg-[#262626]  dark:text-[#ffffff] text-[#000000] shadow-lg z-50  dark:shadow-black max-w-sm mx-auto py-4 w-full rounded-md ">
          <div className="text-[#000000] dark:text-[#ffffff] flex flex-row justify-between items-center border-b-2 dark:border-[#555555] px-2 pb-2 w-full">
            ...
            <h1 className="text-base font-medium dark:text-[#ffffff] text-[#000000] ">
              Report a problem
            </h1>
          ...
          <div className="px-1 mt-2">
            <div>
                <textarea name="report" id="report" className="w-full min-h-[30vh] outline-none border-2 bg-[#ffffff] transition-all duration-500 dark:bg-[#262626] dark:border-[#555555] p-1 dark:focus:border-[#1b74e4] focus:border-[#1b74e4] rounded-md "></textarea>
            </div>
          ...
          <p className="gray-style text-center dark:text-white">Your Instacity username and browser information will be automatically included in your report.</p>
        </div>
