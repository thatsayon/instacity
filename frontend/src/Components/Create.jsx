...
// import { FaCrop, FaXmark } from "react-icons/fa6";
// import { MdCrop, MdCropRotate, MdOutlineKeyboardArrowLeft } from "react-icons/md";
...
//               <div>
//                 <h1 className="text-base text-black dark:text-white font-semibold  ">
//                   {(isEdit && !isPreview && "Edit") ||
//                     (isPreview && "Preview") ||
//                     (!isPreview && !isEdit && "Create new post")}
//                 </h1>
//               </div>
...
//                       <div className="flex flex-row items-center gap-2">
//                         <button onClick={()=>{'if here is then start crop otherwise not'}} className="dark:bg-black p-2 text-white rounded-full bg-[#262626] cursor-pointer">
//                         <MdCrop />
//                         </button>
//                       <button
//                         className="dark:bg-black p-2 text-white rounded-full bg-[#262626] cursor-pointer"
      ...
      >
        {writeCaption ? (
          ...
          >
            ...
            <div className="flex md:flex-row my-2 flex-col md:gap-1 gap-5 w-full max-w-2xl min-h-[65vh] overflow-y-auto ">
              <div className="md:w-1/2 w-full my-auto">
                {imageArray.length > 0 && (
                  <Swiper
                    modules={[Navigation, Pagination]}
              ...
              <div className="md:w-1/2 w-full md:overflow-y-auto max-h-[95vh]">
                <section className="px-1">
                  <div className="flex items-start pt-2 dark:text-[#ffffff] text-black w-full">
                    <div>
                      <img
          ...
          >
            ...
            {imageArray.length > 0 ? (
              isEdit ? (
                <div className="max-h-[95vh] my-2 max-w-[600px] md:w-[450px] w-[350px] min-h-[65vh] flex flex-col items-center justify-center overflow-y-auto overflow-hidden">
                  <div
                    className={`${
                      isPreview ? "hidden" : "flex"} flex-col  justify-center`}
                  >
                    {isCrop ? (
                      <ReactCrop
                        className="md:w-[420px] w-[280px] overflow-hidden"
                        crop={crop}
                        onChange={(pixelCrop, percentCrop) =>
                          setCrop(percentCrop)
                        }
                      ...
                      <div className="md:w-[420px] w-[280px] overflow-hidden">
                        <img
                          ref={imgRef}
                          src={imageArray[activeIndex]}
                          alt="Upload"
                    ...
                    <div className="flex flex-row items-center justify-between  px-2">
                      <div className="flex flex-row items-center gap-2">
                        <button
                          className="dark:bg-black p-2 text-white rounded-full bg-[#262626] cursor-pointer"
                          onClick={() =>
                            setScale((pre) => Math.min(pre + 0.1, 3))
                          }
                        >
                          <FiZoomIn />
                        </button>
                        <button
                          className="dark:bg-black p-2 text-white rounded-full bg-[#262626] cursor-pointer"
                          onClick={() =>
                            setScale((pre) => Math.max(pre - 0.1, 0.5))
                          }
                        >
                          <FiZoomOut />
                        </button>
                  ...
                  <div>
                    ...
                    >
                      <canvas
                       className=" md:w-[420px] block object-contain w-[280px] overflow-hidden"
                        ref={previewCanvasRef}
                ...
                <div>
                  {/* ------here-is--image--------- */}
                  <div
                    className={`flex items-center my-2 justify-center md:w-[400px] w-[280px]  h-auto`}
                  >
                    {imageArray.length > 0 && (
                      <Swiper
                        ref={swiperRef}
