...
import { FaL, FaXmark } from "react-icons/fa6";
                    ...
                    <div className="relative">
                      ...
                      }
                      {
                        ...
                        isAddMore && (
                          <div
                            ref={MoreRef}
                            className="bg-[#1a1a1acc] z-[99999] p-2  rounded-md absolute top-[-80px] right-[35px] gap-2 flex flex-row min-w-[150px] max-w-sm h-fit  items-center"
                          >
