...
//                 {imageArray.length > 0 && (
//                   <p
//                     onClick={() => setWriteCaption(true)}
//                     className={` ${
//                       isCrop && isPreview ? "hidden" : "block"
//                     } follow-link-color text-base font-bold`}
//                   >
//                     Next
//                   </p>
//                 )}
...
//               isCrop ? (
//                 <div
//                   className={`max-h-[95vh]  max-w-[600px] md:w-[450px] w-[350px] min-h-[65vh]  flex flex-col items-center justify-center overflow-y-auto overflow-hidden`}
//                 >
...
//                         className={`btn-medium mt-3 hover:cursor-pointer`}
//                       >
//                         Save
//                       </p>
//                     </div>
...
//                           <div
//                             ref={ZoomRef}
//                             className=" bg-[#1a1a1acc] py-1 rounded-md absolute top-[-50px] md:left-[-360px] left-[-185px] z-50"
//                           >
//                             <input
