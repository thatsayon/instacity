...
function AspectRatioImageResizer() {
  return (
    <div>AspectRatioImageResizer</div>
  )
}
...
//           className={`min-h-[50vh] relative overflow-y-auto overflow-hidden shadow-lg bg-white dark:bg-[#262626] dark:text-[#ffffff] text-black font-bold shadow-[#364e7e1a]  min-w-96 py-4 rounded-xl flex items-center ${imageArray.length ? "gap-0" : "gap-20"
//             } flex-col`}
//         >
//           {
...
//                 <div
//                   onClick={HandleResizeImage("original", 0)}
...
//                 <div
//                   onClick={HandleResizeImage("1:1", 0)}
//                   className="flex items-center px-2 cursor-pointer"
//                 >
//                   <div className="flex flex-col justify-center mr-2">
...
//                 <div
//                   onClick={HandleResizeImage("4:5", 0)}
//                   className="flex items-center px-2 cursor-pointer"
//                 >
//                   <div className="flex flex-col justify-center mr-2">
...
//                 <div
//                   onClick={HandleResizeImage("16:9", 0)}
//                   className="flex items-center px-2 cursor-pointer"
//                 >
//                   <div className="flex flex-col justify-center mr-2">
...
//             // ----This-is-zoomPopup-----
//             isZoom && (
//               <div ref={HiddenPopup} className=" bg-[#1a1a1acc] py-1 rounded-md absolute top-[395px] left-[55px] z-50">
...
//                   }}
//                   style={{
//                     background: 'linear-gradient(to right, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 0%, rgb(0, 0, 0) 0%, rgb(0, 0, 0) 100%)'
//                   }}
//                 />
//               </div>
//             )
...
//             isAddMore && (
//               <div ref={HiddenPopup} className="bg-[#1a1a1acc] p-2 rounded-md absolute top-[370px] z-50 right-[5px] flex flex-row w-[150px] max-w-sm h-fit gap-4 items-center">

//                 <div className={`w-[100px] overflow-hidden relative`}>
//                   <p className="absolute cursor-pointer right-[2px] top-[2px] rounded-full bg-[#1a1a1acc] p-2 text-white font-normal text-sm"><FaXmark /></p>
//                   {imageArray.length && (
//                     <img
//                       src={anynomoususer}
//                       alt="Resized"
...
//                   <p onClick={Handleimageupload} className="border-2 dark:border-[#555555] p-4 rounded-full text-base">
//                     <FiPlus />
//                   </p>
...
//               {/* ------here-is--image--------- */}
//               <div
//                 className={`max-h-[450px] max-w-[450px] h-[395px] w-[395px] flex items-center justify-center overflow-hidden`}
//               >
//                 {imageArray.length && (
//                   <img
//                     src={anynomoususer}
...
//                   <p onClick={() => { setAddMore(!isAddMore) }} className="dark:bg-black p-2 rounded-full bg-[#262626] cursor-pointer">
//                     <svg
...
//     const handleClickOutside = (e) => {
//       if (
//         HiddenPopup.current && !HiddenPopup.current.contains(e.target)
...
//         <div
//           style={{ maxHeight: "calc(100vh - 10vh)" }}
//           className={`min-h-[50vh] relative overflow-y-auto overflow-hidden shadow-lg bg-white dark:bg-[#262626] dark:text-[#ffffff] text-black font-bold shadow-[#364e7e1a]  min-w-96 py-4 rounded-xl flex items-center ${image.length ? "gap-0" : "gap-20"
//             } flex-col`}
//         >
//           {
//             // ----This-is-AspectRatioPopup-----
...
//                     className="hidden"
//                     ref={clickFile}
//                     onChange={HandleMoreImage}
//                   />
//                   <button onClick={() => {
//                     clickFile?.current?.click();
//                   }} className="border-2 dark:border-[#555555] p-4 rounded-full text-base">
//                     <FiPlus />
//                   </button>
