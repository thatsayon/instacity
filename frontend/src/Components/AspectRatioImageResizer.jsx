...
//           className={`min-h-[50vh] relative overflow-y-auto overflow-hidden shadow-lg bg-white dark:bg-[#262626] dark:text-[#ffffff] text-black font-bold shadow-[#364e7e1a]  min-w-[400px] py-4 rounded-md flex items-center ${
//             imageArray.length ? "gap-0" : "gap-20"
//           } flex-col`}
//         >
//           {
